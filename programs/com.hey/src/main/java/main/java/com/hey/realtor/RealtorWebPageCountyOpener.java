package main.java.com.hey.realtor;
...
public class RealtorWebPageCountyOpener {
	...
	private static boolean shouldTabBeOpened(CityStats.Data data) throws Exception {
		return !data.metroPopulation.contains("N/A") && data.metro.contains("Vegas") && data.stateName.equals("Nevada") && Util.getDaysSinceLastUpdated(data) > 10;
	}
