...
public class WhiteMenBachelorsDegree extends CensusMdGeneratorGeneric {

	@Override
	protected String getMainHeaderText() {
		return "Percentage of white men over the age of 25 with a bachelor's degree or higher in the USA sorted in descending order by";
	}

	@Override
	protected String getRemainingHeaders() {
		return "Population|% White|% of white men with a bachelor's degree or higher|";
	}

	@Override
	protected String[] getVariables() {
		return new String[] { "C15002A_002E(num white men who are eligible)", "C15002A_006E(num white men with bachelors)",
	...
	private static double getBachelorsDegreePercent(Map<String, String> map) {
		double numPeopleEligible = Double.valueOf(map.get("C15002A_002E(num white men who are eligible)"));
	...
	public static void main(String[] args) throws Exception {
		new WhiteMenBachelorsDegree().doEverything();
	}
}
