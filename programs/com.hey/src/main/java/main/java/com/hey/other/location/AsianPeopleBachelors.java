...
public class AsianPeopleBachelors extends CensusMdGeneratorGeneric {

	@Override
	protected String getMainHeaderText() {
		return "Percentage of Asian people over the age of 25 with a bachelor's degree or higher in the USA sorted in descending order by";
	}

	@Override
	protected String getRemainingHeaders() {
		return "Population|% Asian|% of Asian people with a bachelor's degree or higher|";
	}

	@Override
	protected String[] getVariables() {
		return new String[] { "C15002D_001E(num asian people who are eligible)",
				"C15002D_006E(num asian men with bachelors)", "B02001_005E(number of asian people)",
				ACS2021DataReader.POPULATION, "C15002D_011E(num asian women with bachelors)" };
	}

	@Override
	protected boolean removeRow(Map<String, String> map) {
		int numPeopleOfTheRace = Integer.valueOf(map.get("B02001_005E(number of asian people)"));
		return numPeopleOfTheRace < 1000;
	}
	...
	private static double getBachelorsDegreePercent(Map<String, String> map) {
		double numPeopleEligible = Double.valueOf(map.get("C15002D_001E(num asian people who are eligible)"));
		double numPeopleQualified = Double.valueOf(map.get("C15002D_006E(num asian men with bachelors)"))
				+ Double.valueOf(map.get("C15002D_011E(num asian women with bachelors)"));
		;
	...
	public static void main(String[] args) throws Exception {
		new AsianPeopleBachelors().doEverything();
	}
}
