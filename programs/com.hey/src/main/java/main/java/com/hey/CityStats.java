...
public abstract class CityStats extends CityStatsSuper {
	...
	public String[] getHeaders() {
		return new String[] { CITY, STATE, POPULATION, POPULATION_DENSITY, METRO_NAME, METRO_POP, HOTTEST_MONTH,
				COLDEST_MONTH, HOTTEST_MINUS_COLDEST, ANNUAL_RAINFALL, ANNUAL_DAYS_OF_PRECIPITATION,
				ANNUAL_DAYS_OF_SUNSHINE, ANNUAL_SNOWFALL, AVERAGE_SUMMER_DEW_POINT, DEW_POINT, WIND_SPEED, AGE,
				BACHELORS, INCOME, POVERTY_RATE, RENT, HOME_PRICE, HOME_SQFT, COST_PER_SQFT, HOME_AGE,
				HOMEOWNERSHIP_RATE, AIR_QUALITY_IDX, UNEMPLOYMENT_RATE, COUNTY, DEMOCRAT, REPUBLICAN, ASIAN, BLACK,
				WHITE, HISPANIC, FOREIGN_BORN, TIME_ZONE, ELEVATION, UV_INDEX, SINGLE_POPULATION, VIOLENT_CRIMES_FBI,
				PROPERTY_CRIMES_FBI, FIPS_CODE, LAND_AREA, LABOR_FORCE };
	}
