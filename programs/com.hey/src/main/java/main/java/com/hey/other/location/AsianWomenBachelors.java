...
public class AsianWomenBachelors extends CensusMdGeneratorGeneric {

	@Override
	protected String getMainHeaderText() {
		return "Percentage of Asian women over the age of 25 with a bachelor's degree or higher in the USA sorted in descending order by";
	}

	@Override
	protected String getRemainingHeaders() {
		return "Population|% Asian|% of Asian women with a bachelor's degree or higher|";
	}

	@Override
	protected String[] getVariables() {
		return new String[] { "C15002D_007E(num asian women who are eligible)", "C15002D_011E(num asian women with bachelors)",
				"B02001_005E(number of Asian people)", ACS2021DataReader.POPULATION };
	}
	...
	private static double getBachelorsDegreePercent(Map<String, String> map) {
		double numPeopleEligible = Double.valueOf(map.get("C15002D_007E(num asian women who are eligible)"));
		double numPeopleQualified = Double.valueOf(map.get("C15002D_011E(num asian women with bachelors)"));
