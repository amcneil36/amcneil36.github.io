...
public class AsianPeopleHomeOwnershipRate extends CensusMdGeneratorGeneric {

	@Override
	protected String getMainHeaderText() {
		return "Homeownership rate of Asian households in the USA sorted in descending order by";
	}

	@Override
	protected String getRemainingHeaders() {
		return "Population|% Asian|Homeownership rate of Asian people|";
	}

	@Override
	protected String[] getVariables() {
		return new String[] { "B25003D_001E(num asian people who are eligible)",
				"B25003D_002E(num asian ppl who own homes)", "B02001_005E(number of asian people)",
				ACS2021DataReader.POPULATION };
	}

	@Override
	protected boolean removeRow(Map<String, String> map) {
		int numPeopleOfRace = Integer.valueOf(map.get("B02001_005E(number of asian people)"));
	...
	private static double getHomeOwnershipRatePercent(Map<String, String> map) {
		double numPeopleEligible = Double.valueOf(map.get("B25003D_001E(num asian people who are eligible)"));
		double numPeopleQualified = Double.valueOf(map.get("B25003D_002E(num asian ppl who own homes)"));
		;
	...
	public static void main(String[] args) throws Exception {
		new AsianPeopleHomeOwnershipRate().doEverything();
	}
}
