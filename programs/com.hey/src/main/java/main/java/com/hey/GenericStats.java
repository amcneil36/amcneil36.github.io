...
public abstract class GenericStats extends GenericStatsSuper {
	...
	public String[] getHeader() {
		return new String[] { POPULATION_DENSITY, INCOME, BACHELORS, AGE, HOME_PRICE, HOME_SQFT, COST_PER_SQFT,
				...
				FOREIGN_BORN, TIME_ZONE, HOTTEST_MONTH, COLDEST_MONTH, HOTTEST_MINUS_COLDEST, HOTTEST_MONTH_AVG_LOW,
				COLDEST_MONTH_AVG_LOW, ANNUAL_HUMIDITY, SUMMER_HUMIDITY, ANNUAL_DEW_POINT, SUMMER_DEW_POINT,
				HOTTEST_MONTHS_HEAT_INDEX_HIGH, ANNUAL_SUNSHINE, SUMMER_SUNSHINE, WINTER_SUNSHINE, ANNUAL_RAINFALL,
				SUMMER_RAINFALL, WINTER_RAINFALL, PERCENT_OF_DAYS_WITH_RAIN, PERCENT_OF_SUMMER_DAYS_WITH_RAIN,
				PERCENT_OF_WINTER_DAYS_WITH_RAIN, ANNUAL_SNOWFALL, DAYS_OF_SNOW_PER_YEAR, WIND_SPEED,
				ANNUAL_THUNDERSTORMS, AIR_QUALITY_IDX, UV_INDEX, LATITUDE, LONGITUDE,
		};
	}
