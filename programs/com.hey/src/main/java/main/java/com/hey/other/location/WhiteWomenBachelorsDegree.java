...
public class WhiteWomenBachelorsDegree extends CensusMdGeneratorGeneric {
	...
	protected String getMainHeaderText() {
		return "Percentage of white women over the age of 25 with a bachelor's degree or higher in the USA sorted in descending order by";
	}

	@Override
	protected String getRemainingHeaders() {
		return "Population|% White|% of white women with a bachelor's degree or higher|";
	}
	...
	private static double getBachelorsDegreePercent(Map<String, String> map) {
		double numPeopleEligible = Double.valueOf(map.get("C15002A_007E(num white women who are eligible)"));
		double numPeopleQualified = Double.valueOf(map.get("C15002A_011E(num white women with bachelors)"));
	...
	public static void main(String[] args) throws Exception {
		new WhiteWomenBachelorsDegree().doEverything();
	}
}
