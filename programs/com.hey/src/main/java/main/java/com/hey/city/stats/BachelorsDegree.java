...
public class BachelorsDegree extends CityStats {
	...
	private static String[] variables = new String[] { ACS2021DataReader.POPULATION, ACS2021DataReader.BACHELORS_DEGREE,
			ACS2021DataReader.MASTERS_DEGREE, ACS2021DataReader.PROFESSIONAL_DEGREE,
			ACS2021DataReader.DOCTORATE_DEGREE, ACS2021DataReader.NUM_PEOPLE_OVER_25_EDUCATION };

	public static void main(String[] args) throws Exception {
		// number of people with a bachelors or higher is number of people where bachelors is the highest they have + num people with masters + doctoral, etc
