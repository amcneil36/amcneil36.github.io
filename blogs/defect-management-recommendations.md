...
The people in support should use Kanban. Kanban works a lot better than Scrum for unpredictability that results in defects being reported at any given time. With scrum, you try to plan your sprint such that you can produce a potentially shippable product increment that you can demo at the end of the sprint for feedback. It is really hard to plan a sprint when defects can come pouring in and change what you have to work on. Sprint planning in scrum is very hard to plan when there can be many interuptions. If a defect were to come in, you would try to place the defect in the next sprint if it's not critical. Otherwise you would have to pull it in the sprint. With Kanban, you can take any incoming important defect and just place it at the top of the product backlog and get to it next.
