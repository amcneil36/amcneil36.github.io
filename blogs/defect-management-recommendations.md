...
Option 1 is very easy to do, has a predictable velocity, and makes it easy to get valuable feedback at the demo. The downside is that the most important items might not be worked on at any point in time due to having 1 or 2 people that need to do support no matter what. We would need a team that has a decent amount of defects or tech debt for it to be worth considering having anyone fully allocated to support for a whole sprint. 
