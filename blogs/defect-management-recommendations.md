...
The problem with the zero defect backlog approach is that it assumes that all incoming defects are of a higher priority than the feature that is being worked on. Some of these incoming defects will be a higher priority than the feature that is being worked on. Some of these defects will not be. 
