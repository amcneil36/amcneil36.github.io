...
Defects take time and effort to fix. Any time spent fixing a defect is less time spent working on a feature. The customer has to make a business decision based on the cost of having the bug vs the value of getting another feature. 
