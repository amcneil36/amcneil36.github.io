...
The investigation portion might be making note of things such as how frequently the bug occurs, how high the impact is when the bug does occur, assigning a priority to the ticket, determining if the issue is a defect or enhancement, estimating the time it will take to fix the issue, or closing the ticket after determining it's not an issue.  
